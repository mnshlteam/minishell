...
#    Updated: 2022/09/12 18:11:25 by hyejo            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIB_DIR		=	libft
LIB			=	libft/libft.a
SRCS		=	minishell.c directory.c echo.c env_ctrl.c env.c execute.c parse.c parse_quotes.c split_str.c utils.c utils2.c
OBJS		=	$(SRCS:.c=.o)
LIBFT		=	-Llibft -lft
